          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 30%;"> Tanggal Berakhir </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <?php if($product['tgl_akhir'] >  $tgl_sekarang): ?>
                    <span class="label label-success"><?php echo remove_junk('Kontrak Berjalan'); ?></span>
                  <?php else: ?>
                    <span class="label label-danger"><?php echo remove_junk('Kontrak Habis'); ?></span>
                  <?php endif;?>
                </td>
              </tr>
             <?php endforeach; ?>
